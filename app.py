...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            if len(parts)==4 and parts[:2]==["api","variants"] and parts[3]=="reviews": return self._json(200,{"ok":True,"review":self.db.review_variant(int(parts[2]),str(b.get("decision","")),str(b.get("comment","")),int(b.get("user_id",0)),int(b.get("expected_revision",0)))})
